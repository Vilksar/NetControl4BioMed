...
namespace NetControl4BioMed.Helpers.Algorithms.Analyses.Genetic
{
    ...
    public class Chromosome
    {
        ...
        public Chromosome Crossover(Chromosome secondChromosome, Dictionary<string, int> nodeIndex, List<Matrix<double>> powersMatrixCA, Dictionary<string, bool> nodeIsPreferred, CrossoverType crossoverType, Random random)
        {
            ...
            switch (crossoverType)
            {
                ...
                case CrossoverType.WeightedRandom:
                    // Repeat while the chromosome is not valid.
                    while (tries > 0)
                    {
                        // Decrease the number of tries.
        ...
        public Chromosome Mutate(Dictionary<string, int> nodeIndex, Dictionary<string, List<string>> targetAncestors, List<Matrix<double>> powersMatrixCA, Dictionary<string, bool> nodeIsPreferred, MutationType mutationType, double mutationProbability, Random random)
        {
            // Define the number of tries in which to try and find a valid chromosome.
            var tries = _tries;
