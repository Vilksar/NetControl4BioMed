...
{
    /// <summary>
    /// Provides extensions for the samples.
    /// </summary>
    public static class SampleExtensions
    {
        ...
        public static async Task DeleteRelatedEntitiesAsync<T>(IEnumerable<string> itemIds, IServiceProvider serviceProvider, CancellationToken token) where T : class, ISampleDependent
        {
            ...
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                entityCount = set
                    .Where(item => itemIds.Contains(item.Sample.Id))
                    .Count();
            }
