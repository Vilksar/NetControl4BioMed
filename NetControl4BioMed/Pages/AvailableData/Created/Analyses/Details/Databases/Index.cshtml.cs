...
namespace NetControl4BioMed.Pages.AvailableData.Created.Analyses.Details.Databases
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            // Redirect to the index page.
            return RedirectToPage("/AvailableData/Created/Analyses/Details/Index", new { id = View.Analysis.Id });
        }
    }
}
