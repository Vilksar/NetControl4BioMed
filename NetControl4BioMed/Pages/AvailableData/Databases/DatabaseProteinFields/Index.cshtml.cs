...
namespace NetControl4BioMed.Pages.AvailableData.Databases.DatabaseProteinFields
{
        ...
        public class ViewModel
        {
            ...
            public static SearchOptionsViewModel SearchOptions { get; } = new SearchOptionsViewModel
            {
                ...
                Filter = new Dictionary<string, string>
                {
                    ...
                    { "HasDatabaseProteinFieldProteins", "Has proteins" },
                    { "HasNoDatabaseProteinFieldProteins", "Does not have proteins" }
                },
                SortBy = new Dictionary<string, string>
                {
                    ...
                    { "DatabaseId", "Database ID" },
                    { "DatabaseName", "Database name" },
                    { "DatabaseProteinFieldProteinCount", "Number of proteins" }
                }
            };
        }
