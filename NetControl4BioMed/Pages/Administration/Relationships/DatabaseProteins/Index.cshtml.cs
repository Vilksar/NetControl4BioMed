...
namespace NetControl4BioMed.Pages.Administration.Relationships.DatabaseProteins
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            public SearchViewModel<DatabaseProtein> Search { get; set; }
        ...
        public IActionResult OnGet(string searchString = null, IEnumerable<string> searchIn = null, IEnumerable<string> filter = null, string sortBy = null, string sortDirection = null, int? itemsPerPage = null, int? currentPage = 1)
        {
            ...
            var query = _context.DatabaseProteins
            ...
            View = new ViewModel
            {
                Search = new SearchViewModel<DatabaseProtein>(_linkGenerator, HttpContext, input, query)
            };
            // Return the page.
            return Page();
        }
