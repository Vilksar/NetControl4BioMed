...
namespace NetControl4BioMed.Pages.Administration.Created.BackgroundTasks
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            public SearchViewModel<BackgroundTask> Search { get; set; }
            ...
            public static SearchOptionsViewModel SearchOptions { get; } = new SearchOptionsViewModel
            {
                ...
                Filter = new Dictionary<string, string>
                {
                    ...
                    { "IsNotRecurring", "Is not recurring" }
                },
        ...
        public IActionResult OnGet(string searchString = null, IEnumerable<string> searchIn = null, IEnumerable<string> filter = null, string sortBy = null, string sortDirection = null, int? itemsPerPage = null, int? currentPage = 1)
        {
            ...
            query = query
                .Where(item => input.Filter.Contains("IsRecurring") ? item.IsRecurring : true)
                .Where(item => input.Filter.Contains("IsNotRecurring") ? !item.IsRecurring : true);
            ...
            View = new ViewModel
            {
                Search = new SearchViewModel<BackgroundTask>(_linkGenerator, HttpContext, input, query)
            };
            // Return the page.
            return Page();
        }
