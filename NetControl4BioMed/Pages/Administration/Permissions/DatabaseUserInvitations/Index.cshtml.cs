...
namespace NetControl4BioMed.Pages.Administration.Permissions.DatabaseUserInvitations
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            public SearchViewModel<DatabaseUserInvitation> Search { get; set; }
        ...
        public IActionResult OnGet(string searchString = null, IEnumerable<string> searchIn = null, IEnumerable<string> filter = null, string sortBy = null, string sortDirection = null, int? itemsPerPage = null, int? currentPage = 1)
        {
            ...
            var query = _context.DatabaseUserInvitations
                .Where(item => true);
            ...
            View = new ViewModel
            {
                Search = new SearchViewModel<DatabaseUserInvitation>(_linkGenerator, HttpContext, input, query)
            };
            // Return the page.
            return Page();
        }
