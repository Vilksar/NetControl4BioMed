...
namespace NetControl4BioMed.Pages.Administration.Accounts.Roles
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            public SearchViewModel<Role> Search { get; set; }
        }
        ...
        public IActionResult OnGet(string searchString = null, IEnumerable<string> searchIn = null, IEnumerable<string> filter = null, string sortBy = null, string sortDirection = null, int? itemsPerPage = null, int? currentPage = 1)
        {
            ...
            query = query
                ...
                .Where(item => input.Filter.Contains("HasNoUsers") ? !item.UserRoles.Any() : true);
            ...
            View = new ViewModel
            {
                Search = new SearchViewModel<Role>(_linkGenerator, HttpContext, input, query)
            };
            // Return the page.
            return Page();
        }
