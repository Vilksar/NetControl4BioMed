...
namespace NetControl4BioMed.Pages.Administration.Data.Interactions
{
    ...
    public class DeleteModel : PageModel
    {
        ...
        {
            public IEnumerable<Interaction> Items { get; set; }
        }
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            var task = new BackgroundTask
            {
                ...
                {
                    Items = View.Items.Select(item => new InteractionInputModel
                    {
                        Id = item.Id
                    })
            ...
            // Display a message.
            TempData["StatusMessage"] = $"Success: A new background job was created to delete {itemCount} interaction{(itemCount != 1 ? "s" : string.Empty)}.";
            // Redirect to the index page.
            return RedirectToPage("/Administration/Data/Interactions/Index");
        }
    }
