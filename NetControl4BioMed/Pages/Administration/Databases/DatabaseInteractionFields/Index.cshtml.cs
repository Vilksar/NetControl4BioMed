...
namespace NetControl4BioMed.Pages.Administration.Databases.DatabaseInteractionFields
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            public SearchViewModel<DatabaseInteractionField> Search { get; set; }
        ...
        public IActionResult OnGet(string searchString = null, IEnumerable<string> searchIn = null, IEnumerable<string> filter = null, string sortBy = null, string sortDirection = null, int? itemsPerPage = null, int? currentPage = 1)
        {
            ...
            View = new ViewModel
            {
                Search = new SearchViewModel<DatabaseInteractionField>(_linkGenerator, HttpContext, input, query)
            };
            // Return the page.
            return Page();
        }
