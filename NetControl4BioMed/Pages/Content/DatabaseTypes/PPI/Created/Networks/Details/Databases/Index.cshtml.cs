...
namespace NetControl4BioMed.Pages.Content.DatabaseTypes.PPI.Created.Networks.Details.Databases
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            // Redirect to the index page.
            return RedirectToPage("/Content/DatabaseTypes/PPI/Created/Networks/Details/Index", new { id = View.Network.Id });
        }
    }
}
