...
namespace NetControl4BioMed.Pages.Content.DatabaseTypes.PPI.Created.Networks.Details.Accounts.Users
{
    public class AddModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            {
                // Display a message.
                TempData["StatusMessage"] = "Error: You need to be logged in to add a user to the network.";
                // Redirect to the index page.
                return RedirectToPage("/Content/DatabaseTypes/PPI/Created/Networks/Details/Accounts/Users/Index", new { id = View.Network.Id });
            }
            // Define the input.
        ...
        public async Task<IActionResult> OnPostAsync(string id)
        {
            ...
            var emailAddedToNetworkViewModel = new EmailAddedToNetworkViewModel
            {
                ...
                Url = _linkGenerator.GetUriByPage(HttpContext, "/Content/DatabaseTypes/PPI/Created/Networks/Details/Index", handler: null, values: new { id = View.Network.Id }),
