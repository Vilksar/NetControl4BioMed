...
namespace NetControl4BioMed.Pages.Content.DatabaseTypes.PPI.Databases.DatabaseTypes
{
    public class DetailsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                return RedirectToPage("/Content/DatabaseTypes/PPI/Databases/DatabaseTypes/Index");
            }
