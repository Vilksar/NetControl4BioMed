...
using NetworkItemModel = NetControl4BioMed.Pages.Content.DatabaseTypes.PPI.Created.Networks.IndexModel.ItemModel;
using AnalysisItemModel = NetControl4BioMed.Pages.Content.DatabaseTypes.PPI.Created.Analyses.IndexModel.ItemModel;
