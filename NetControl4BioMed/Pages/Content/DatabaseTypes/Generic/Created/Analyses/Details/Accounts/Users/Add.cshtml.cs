...
namespace NetControl4BioMed.Pages.Content.DatabaseTypes.Generic.Created.Analyses.Details.Accounts.Users
{
    public class AddModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            if (user == null)
            {
                ...
                // Redirect to the index page.
                return RedirectToPage("/Content/DatabaseTypes/Generic/Created/Analyses/Details/Accounts/Users/Index", new { id = View.Analysis.Id });
            }
            // Define the input.
        ...
        public async Task<IActionResult> OnPostAsync(string id)
        {
            ...
            var emailAddedToAnalysisViewModel = new EmailAddedToAnalysisViewModel
            {
                ...
                Url = _linkGenerator.GetUriByPage(HttpContext, "/Content/DatabaseTypes/Generic/Created/Analyses/Details/Index", handler: null, values: new { id = View.Analysis.Id }),
