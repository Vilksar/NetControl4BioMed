...
namespace NetControl4BioMed.Pages.Content.DatabaseTypes.Generic.Created.Networks.Details.Accounts.Users
{
    public class AddModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            if (user == null)
            {
                ...
                // Redirect to the index page.
                return RedirectToPage("/Content/DatabaseTypes/Generic/Created/Networks/Details/Accounts/Users/Index", new { id = View.Network.Id });
            }
            // Define the input.
