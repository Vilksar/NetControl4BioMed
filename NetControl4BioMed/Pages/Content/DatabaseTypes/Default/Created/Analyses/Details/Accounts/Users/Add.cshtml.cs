...
namespace NetControl4BioMed.Pages.Content.DatabaseTypes.Default.Created.Analyses.Details.Accounts.Users
{
    public class AddModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            if (user == null)
            {
                ...
                // Redirect to the index page.
                return RedirectToPage("/Content/DatabaseTypes/Default/Created/Analyses/Details/Accounts/Users/Index", new { id = View.Analysis.Id });
            }
            // Define the input.
