...
namespace NetControl4BioMed.Pages.Content.DatabaseTypes.Default.Databases.DatabaseEdgeFields
{
    public class DetailsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            if (string.IsNullOrEmpty(id))
            {
                ...
                return RedirectToPage("/Content/DatabaseTypes/Default/Databases/DatabaseEdgeFields/Index");
            }
