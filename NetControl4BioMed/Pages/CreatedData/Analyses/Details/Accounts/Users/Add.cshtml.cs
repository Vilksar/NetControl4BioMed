...
namespace NetControl4BioMed.Pages.CreatedData.Analyses.Details.Accounts.Users
{
    public class AddModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string id)
        {
            ...
            if (user == null || !items.Any(item => item.AnalysisUsers.Any(item1 => item1.Email == user.Email)))
            {
                ...
                // Redirect to the index page.
                return RedirectToPage("/CreatedData/Analyses/Details/Accounts/Users/Index", new { id = View.Analysis.Id });
            }
            // Define the input.
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var emailAddedToAnalysisViewModel = new EmailAddedToAnalysisViewModel
            {
                ...
                Url = _linkGenerator.GetUriByPage(HttpContext, "/CreatedData/Analyses/Details/Index", handler: null, values: new { id = View.Analysis.Id }),
