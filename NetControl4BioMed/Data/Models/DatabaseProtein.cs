...
{
    /// <summary>
    /// Represents the database model of a one-to-one relationship between a database and a protein which it contains.
    /// </summary>
    public class DatabaseProtein : IDatabaseDependent, IProteinDependent
    {
        /// <summary>
